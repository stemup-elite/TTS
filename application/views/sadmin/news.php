              ...
              <form id="create_new_stemup">
                <div class="col-md-9 pl-0">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-12">
                      <textarea name="ckeditor" class="ckeditor form-control" placeholder="Tạo câu hỏi trắc nghiệm" id="editor1" rows="20" cols="80">
                      </textarea>
                    </div>
                  </div>
                </div>
                ...
                <div class="form-group">   
                  ...
                  <div class="col-md-9 p0 MT20">
                    <select id="sltype" class="form-control">
                      ...
                      foreach($class as $cl) {
                        ?>
                        <option value="<?php echo $cl['id'] ?>"><?php echo $cl['category_name'] ?></option>
                        <?php
                      } 
                      ?>
                    </select>
                                ...
                                <tbody>
                                 ...
                                 foreach ($list_news as $key =>$value ) {
                                  ...
                                  <tr>
                                    ...
                                    <!-- <td class="ta-c"><?php echo $key->category_name?></td> -->
                                    <td class="ta-c"><?php echo date("d-m-Y", strtotime($value['modify_date']))?></td> 
                                    <!-- <td class="ta-c"><?php echo date("d-m-Y", strtotime($key->modify_date))?></td> -->
                                    <td class="ta-c"><input type="checkbox" name="cb-chon" class="cb-chon" value="<?php echo $value['id']?>"></td>
                                  </tr>
                                  <?php
                                }
                                ?>
